...
export const PRESS_POSTS: PressPost[] = [
  {
    ...
    description: {
      it: "A marzo 2026 pacchi misteriosi recuperati, sostenibilità ed economia circolare arrivano in provincia di Brindisi.",
      en: "In March 2026, recovered mystery parcels, sustainability and circular economy arrive in the Brindisi area.",
      es: "En marzo de 2026 llegan a Brindisi paquetes misteriosos recuperados, sostenibilidad y economía circular.",
      fr: "En mars 2026, colis mystères récupérés, durabilité et économie circulaire arrivent à Brindisi.",
      de: "Im März 2026 kommen gerettete Mystery-Pakete, Nachhaltigkeit und Kreislaufwirtschaft nach Brindisi.",
    },
...
Nel mese di marzo 2026, il pubblico potrà vivere un’esperienza di shopping diversa dal solito: pacchi sigillati di varie dimensioni, acquistabili a sorpresa, senza conoscere il contenuto prima dell’acquisto.
...
KiloMystery arrives in the Brindisi area with a temporary pop-up dedicated to recovered mystery parcels, combining curiosity, sustainability and circular economy.

In March 2026, visitors will experience a different kind of shopping: sealed parcels of various sizes, purchased as a surprise without knowing the contents beforehand.
...
KiloMystery’s arrival in the Brindisi area marks a new step in raising awareness about waste, proving that sustainability and surprise can coexist.
...
KiloMystery llega a Brindisi con un pop-up temporal dedicado a paquetes misteriosos recuperados.

En marzo de 2026, el público podrá vivir una experiencia diferente: paquetes sellados comprados a sorpresa sin conocer su contenido.

Cada año miles de envíos no entregados son destruidos.  
KiloMystery transforma este desperdicio en una experiencia responsable.

El proyecto da una segunda vida a productos del comercio electrónico europeo.

El acceso es gratuito y abierto a todos.  
...
KiloMystery arrive à Brindisi avec un pop-up temporaire dédié aux colis mystères récupérés.

En mars 2026, le public vivra une expérience de shopping différente.

Le projet donne une seconde vie aux produits issus de l’e-commerce européen.
...
KiloMystery kommt mit einem temporären Pop-up nach Brindisi.

Im März 2026 erleben Besucher eine besondere Shopping-Erfahrung.

Das Projekt fördert Nachhaltigkeit und Kreislaufwirtschaft.
