...
export default function RewardPage({
  ...
  const spin = () => {
    ...
    window.setTimeout(() => {
      ...
      // Fine giri: manda risultato al backend (se non l'abbiamo già mandato)
      if (nextSpins <= 0 && !sentRef.current) {
  ...
  return (
    <main className="container py-8">
      ...
      {/* Se manca l'orderId, avviso ma faccio comunque giocare */}
      {!orderId && (
        <p className="mx-auto mt-4 max-w-3xl text-center text-yellow-300 text-sm">
          Non siamo riusciti a collegare questo giro a un ordine specifico.
          Potrai comunque giocare, ma il bonus potrebbe non essere aggiunto
          automaticamente alle note dell&apos;ordine.
        </p>
      )}
        ...
        >
          ...
          >
            ...
            {sectors.map((s, i) => {
              ...
              const ty = cy + R_OUT * Math.sin(rad(mid));
