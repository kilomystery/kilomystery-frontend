...
const SHIPPING_COPY: Record<Lang, Copy> = {
  it: {
    ...
    timesBullets: [
      ...
      "Consegna stimata: 24–72 ore lavorative in Italia (salvo isole minori o zone difficilmente raggiungibili).",
  ...
  en: {
    ...
    timesBullets: [
      ...
      "Estimated delivery: 24–72 business hours within Italy (excluding smaller islands or hard-to-reach areas).",
  ...
  es: {
    ...
    timesBullets: [
      ...
      "Entrega estimada: 24–72 horas laborables en Italia (salvo islas menores o zonas de difícil acceso).",
  ...
  fr: {
    ...
    timesBullets: [
      ...
      "Livraison estimée : 24–72 heures ouvrées en Italie (hors îles mineures ou zones difficiles d’accès).",
  ...
  de: {
    ...
    timesBullets: [
      ...
      "Voraussichtliche Lieferung: 24–72 Werktstunden innerhalb Italiens (ausgenommen kleinere Inseln oder schwer erreichbare Regionen).",
